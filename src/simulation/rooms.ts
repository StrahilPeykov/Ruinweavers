...
export const ROOMS: Record<string, RoomSpec> = {
  ...
  approach: room(
    ...
    28,
    20,
    "A broad open approach beside a sheltered lateral aisle.",
    [box(-6, -3, 3, 6, 2.2), box(4, 4, 4, 2)],
    [v(-3, 7), v(2, 7)],
    [v(-10, -7), v(9, -6), v(-10, 2), v(7, 2)],
    [{ id: "ballast", kind: "heavy", x: -2, z: -1 }],
  ),
  diagonal: room(
    "diagonal",
    "The oblique court",
    26,
    24,
    "Long diagonal fire crosses two broad lateral escape lanes.",
    [box(-5, -4, 4, 2, 1.7), box(6, 3, 3, 2, 1.7)],
    [v(-7, 8), v(-3, 8)],
    [v(8, -8), v(-8, -8), v(8, 0), v(0, -7)],
    [
      { id: "brittle", kind: "brittle", x: -8, z: 2 },
      { id: "loose-1", kind: "loose", x: 8, z: -2 },
    ],
  ),
  terrace: room(
...
ROOMS.approach.presentation.pigment = 0x9a895c;
ROOMS.diagonal.presentation.pigment = 0x728e7e;
ROOMS.approach.presentation.columns = [-10, -6, 10];
ROOMS.diagonal.presentation.columns = [-9, 6, 10];
