...
Keep host authority, existing connection/relay setup and source provenance. No classes, additional Principles, economy, permanent progression, procedural generation or broader content expansion in this milestone. Use the existing reproducible illustrated asset pipeline.

Success is a small complete playable illustrated run and reliable evidence, not proof of subjective fun. No automatic phase expansion.
